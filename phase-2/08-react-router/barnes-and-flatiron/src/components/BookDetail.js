function BookDetail({deleteBook, addToCart, populateForm, handleLike, book, book:{liked, title,author,price=10,genre,image="https://nnpbeta.wustl.edu/img/bookCovers/genericBookCover.jpg"}}){
