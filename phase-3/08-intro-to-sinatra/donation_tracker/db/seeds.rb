...
# teamseas = Organization.create(name: "Team Seas")

# # Donation.create(amount: 450.00, date: DateTime.new(2021, 11, 8), organization_id: Organization.last.id, donor_id: Donor.last.id)
# Donation.create(amount: 450.00, date: DateTime.new(2021, 11, 8), organization_id: teamseas.id, donor_id: zachary.id)